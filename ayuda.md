...
- Tener instalada la extensión **EasyMariaDB**. [[Descarga de la extensión EasyMariaDB.oxt]](https://github.com/jucasaca/Extension/releases) [[Instalación de la extensión EasyMariaDB]](instalarextension.md)
