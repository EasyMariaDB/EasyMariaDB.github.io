...
- Tener instalado un servidor de bases de datos MaiaDB o MySQL y tener acceso al mismo.. [Descargar e instalar MariaDB](InstalarMariaDB.md) o [Descargar e instalar MySQL](InstalarMySQL.md)
